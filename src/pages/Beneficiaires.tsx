...
// Imports nécessaires pour la modale et le formulaire
...
export default function BeneficiairesPage() {
  ...
  return (
    <Layout>
      <div className="p-8 space-y-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <Button 
            ...
            className="rounded-2xl gap-2 bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-200"
          >
                  ...
                  <div className="flex items-center gap-6">
                    <div className="hidden md:flex items-center gap-2">
                      <div 
                        ...
                        style={{ backgroundColor: getCategorieColor(b.categorie) }}
                      />
      ...
      {/* Fenêtre de formulaire connectée */}
      <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
        <DialogContent className="max-w-2xl rounded-[2rem] bg-white">
          <DialogHeader>
            <DialogTitle className="text-2xl font-black">Nouveau Bénéficiaire</DialogTitle>
          </DialogHeader>
          
          <BeneficiaireForm 
            onSubmit={async (data) => {
              const nouveau: Beneficiaire = {
              ...
              const updated = [nouveau, ...beneficiaires]
